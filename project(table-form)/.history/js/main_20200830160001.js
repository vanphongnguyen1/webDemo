    ...
    function listStudents (list,item) {
        ...
        if(!email) {
            document.getElementsByClassName('error-email').innerHTML='<font color="f00"> Vui lòng điền: Email</font>'
        } else {
            document.getElementsByClassName('error-email').innerHTML=''
        }
        if(!phone) {
            document.getElementsByClassName('error-phone').innerHTML='<font color="f00"> Vui lòng điền: Số điện thoại</font>'
        } else {
            document.getElementsByClassName('error-phone').innerHTML=''
        }
        if(!address) {
            document.getElementsByClassName('error-address').innerHTML='<font color="f00"> Vui lòng điền: Address</font>'
        } else {
            document.getElementsByClassName('error-address').innerHTML=''
        }
        if(!date) {
            document.getElementsByClassName('error-date').innerHTML='<font color="f00"> Vui lòng chọn: Ngày/Tháng/Năm</font>'
        } else {
            document.getElementsByClassName('error-date').innerHTML=''
        }
        if(!gender) {
            document.getElementsByClassName('error-gender').innerHTML='<font color="f00"> Vui lòng chọn: Giới tính</font>'
        } else {
            document.getElementsByClassName('error-gender').innerHTML=''
        }
