    ...
    function editStudent(index) {
        ...
        document.querySelector('.form__button').innerText = 'Update Student'
    }
    function updataStudent () {
        let listStudent = localStorage.getItem('students') ? JSON.parse(localStorage.getItem('students')) : []
        key = document.querySelector('.index').value
        listStudent[key] = {
        ...
        localStorage.setItem('students', JSON.stringify(listStudent))
        document.querySelector('.form__button').innerText = 'Save Student'
    }