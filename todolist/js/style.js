...
// </div> -->
const pushInput = document.querySelector('.aplay-todo__item-input')
...
function createInput (list, item) {
    ...
    btnDelete.innerHTML = '<i class="fal fa-calendar-times"></i>'
    /// tạo thẻ bao bên ngoài
